...
const BASE_CATEGORIES = [
  ...
  { name: 'Побут',      icon: 'ti-home-cog',         color: '#F97316', order: 4  },
  ...
  { name: 'Благодійність', icon: 'ti-heart-handshake', color: '#F43F5E', order: 16 },
  { name: 'Інше',          icon: 'ti-dots',             color: '#9CA3AF', order: 17 },
]
