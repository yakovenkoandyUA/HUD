...
Правила:
- Ігноруй службові рядки: касир, каса, чек, штрих-код без назви, ПН, ТОВ, адреса, оплата, комісія
- Якщо позиція містить тільки штрих-код без читабельної назви товару — пропусти її
- Назву товару скорочуй до зрозумілої: "Шинка СЕЛЯНСЬКА Ятрань 100г" → "Шинка Ятрань"
- Категорії визначай по назві: м'ясо/молочне/овочі/хліб → Продукти, тощо`
