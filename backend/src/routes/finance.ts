...
function buildPrompt(
  ...
  const personaLine = persona
    ? `${persona}\n\n`
    : `Ти Мімір — особистий фінансовий провідник. Говориш від першої особи, тепло але чесно, як старший друг який добре розбирається в цифрах. Не читаєш мораль, але помічаєш те, що людина сама не бачить. Іноді дозволяєш собі легкий іронічний коментар.\n\n`

  return `${personaLine}Проаналізуй витрати за ${monthLabel} українською мовою.

ВИТРАТИ ПО КАТЕГОРІЯХ (поточний vs попередній місяць):
${categoriesText}
