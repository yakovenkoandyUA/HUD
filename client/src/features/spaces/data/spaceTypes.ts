...
export const SPACE_TYPE_CONFIG: Record<SpaceType | 'home', SpaceTypeConfig> & { blank: SpaceTypeConfig; cellar: SpaceTypeConfig } = {
	trip: { label: 'Подорож', description: 'Маршрут, місця, витрати', color: '#3b82f6', iconSrc: `${BASE}/space_navigation.png`, isCover: true },
	...
	pet: { label: 'Вихованець', description: 'Ветеринар, щеплення, догляд', color: '#ea580c', iconSrc: `${BASE}/space_pet.png`, isCover: true },
