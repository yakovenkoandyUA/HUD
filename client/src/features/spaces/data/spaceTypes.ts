...
export const SPACE_TYPE_CONFIG: Record<SpaceType, SpaceTypeConfig> & { blank: SpaceTypeConfig } = {
  trip:    { label: 'Поїздка',    description: 'Маршрут, місця, витрати',     color: '#3b82f6', iconSrc: `${BASE}/elegant_navigation_crest_with_botanical_accents-transparent.png`  },
  ...
  blank:   { label: 'Порожній',   description: 'Почати з нуля',               color: '#71717a', iconSrc: `${BASE}/elegant_botanical_crest_with_plus_symbol-transparent.png`         },
}
