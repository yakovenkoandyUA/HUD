...
export type ProfileTab = 'me' | 'wallet' | 'plan' | 'timeline' | 'spaces' | 'mimir' | 'achievements'
...
export const PROFILE_TABS: { id: ProfileTab; label: string; icon: React.ReactNode; adminOnly?: boolean }[] = [
  ...
  { id: 'achievements', label: 'Руни',      icon: <svg width="22" height="22" viewBox="0 0 22 22" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M7 2h8v7a4 4 0 0 1-8 0V2Z"/><path d="M7 5H4.5a2 2 0 0 0 0 4H7"/><path d="M15 5h2.5a2 2 0 0 0 0 4H15"/><line x1="11" y1="13" x2="11" y2="17"/><path d="M7.5 17h7"/></svg> },
