...
export type ProfileTab = 'me' | 'wallet' | 'plan' | 'timeline' | 'spaces' | 'mimir' | 'achievements' | 'admin'
...
export const PROFILE_TABS: { id: ProfileTab; label: string; icon: React.ReactNode; adminOnly?: boolean }[] = [
  ...
  { id: 'achievements', label: 'Глибина',   icon: <svg width="22" height="22" viewBox="0 0 22 22" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><line x1="11" y1="2" x2="11" y2="20"/><path d="M11 5L17 9M11 5L5 9"/><path d="M11 11L17 15M11 11L5 15"/></svg> },
