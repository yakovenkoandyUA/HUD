...
export const PROFILE_TABS: { id: ProfileTab; label: string; icon: React.ReactNode; adminOnly?: boolean }[] = [
  ...
  { id: 'achievements', label: 'Руни',      icon: <svg width="22" height="22" viewBox="0 0 22 22" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M8 3h6l4 5H4Z"/><path d="M4 8l7 11 7-11"/><line x1="8" y1="3" x2="11" y2="8"/><line x1="14" y1="3" x2="11" y2="8"/></svg> },
