...
interface ProfileState {
  ...
  updateProfile: (patch: { name?: string; avatarUrl?: string; f1Enabled?: boolean; footballEnabled?: boolean; salaryDay?: number; monthlySpendLimit?: number | null; username?: string; city?: string; morningStart?: number; afternoonStart?: number; eveningStart?: number; reportStyle?: string; mediaEnabledTabs?: string[]; unlockedAchievements?: { id: string; unlockedAt: string }[]; sprintTutorialSeen?: boolean; weekdayLongPressTutorialSeen?: boolean; swipeDismissTutorialSeen?: boolean; sprintTutorialShownCount?: number; weekdayLongPressShownCount?: number; swipeDismissShownCount?: number; onboardingCompleted?: boolean; mimirSeenHints?: string[] }) => Promise<void>
