    ...
    <div className={styles.tabContent}>
      ...
      <section className={settingsStyles.section}>
        ...
        <div className={settingsStyles.legalLinks}>
          <a href="/terms" target="_blank" rel="noreferrer" className={settingsStyles.legalLink}>
            <svg width="12" height="12" viewBox="0 0 12 12" fill="none" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round">
              <path d="M2 1.5h8M2 4.5h8M2 7.5h5"/>
            </svg>
            Умови користування
          </a>
          <a href="/privacy" target="_blank" rel="noreferrer" className={settingsStyles.legalLink}>
            <svg width="12" height="12" viewBox="0 0 12 12" fill="none" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round">
